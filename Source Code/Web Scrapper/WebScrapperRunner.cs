    ...
    internal class WebScrapperRunner
    {
        ...
        static Tuple<int?, string> GetLocationInfo(string rawLocation)
        {
            try
            {
                ...
                int? buildingID = null;
                using (BuildingDataContext bdb = new BuildingDataContext())
                {
        ...
        {
            using (CourseDataContext cbd = new CourseDataContext())
            {
                ...
                foreach (string courseCode in list.Courses)
                {
                    ...
                    foreach (string filename in filenames)
                    {
                        ...
                        Web_Scrapper.Course newCourse = new Web_Scrapper.Course();
        ...
        static void HandleInstructors(CourseDataContext cbd, int courseID, MeetingSession session, char? type)
        {
